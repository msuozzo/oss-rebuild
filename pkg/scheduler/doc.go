...
// oss-rebuild coverage: which packages are worth rebuilding, and in what order.
//
...
// T0..T3, each more expensive than the last, and are ordered by DispatchOrder,
// which combines the score with recency so that importance and freshness both
// count.
//
